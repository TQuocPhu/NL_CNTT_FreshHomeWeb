                        ...
                        <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                            <div class="footer-widget footer-about-widget">
                                ...
                                <p>FreshHome - Điểm đến tin cậy cho thực phẩm sạch và hàng tiêu dùng chất lượng.
                                    Chúng tôi cam kết mang đến sự tươi ngon và an toàn cho mỗi bữa ăn gia đình Việt.</p>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="footer-address-info">
                                                <p>Tra Vinh, Vinh Long, Viet Nam</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="footer-address-icon">
                                            ...
                                            <div class="footer-address-info">
                                                <p><a href="tel:+84913193089">+84913193089</a></p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="footer-address-icon">
                                            ...
                                            <div class="footer-address-info">
                                                <p><a href="mailto:tranquocphutv2019@gmail.com">tranquocphutv2019@gmail.com</a>
                                                </p>
                                            </div>
                                        </li>
                                    </ul>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="ltn__copyright-design clearfix">
                                <p>Bản quyền thuộc về FreshHome © <span class="current-year"></span>. Thiết kế bởi đội ngũ FreshHome.</p>
                            </div>
                        </div>
