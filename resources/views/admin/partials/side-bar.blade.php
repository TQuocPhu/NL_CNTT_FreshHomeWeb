<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="{{ route('admin.dashboard') }}" class="site_title"><i class="fa fa-paw"></i> <span>FRESH HOME!</span></a>
        </div>
        ...
        <div class="profile clearfix">
            <div class="profile_pic">
                <img src="{{ $userAdmin->avatar_url }}" alt="{{ $userAdmin->name }}" class="img-circle profile_img">
            </div>
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    @if ($adminUser->role->permissions->contains('name', 'manage_contacts'))
                        <li>
                            <a href="{{ route('admin.contacts.index') }}"><i class="fa fa-paper-plane"></i> Quản Lý Liên hệ </a>
                        </li>
                    @endif
